...
## Getting Started
The only dependency for these labs is Java 21+. Installing `openjdk-21-jdk` on
...
install `make`, Python 3, and Java 21. You can do this on native Windows.
...
If you install WSL, you can install `python3`, `java21`, and `make` through
